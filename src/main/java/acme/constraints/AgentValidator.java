	...
	public boolean isValid(final Agent agent, final ConstraintValidatorContext context) {
		...
		if (agent == null)
		...
		else {
			{
				...
				super.state(context, uniqueAgent, "ticker", "acme.validation.agent.duplicated-code.message");
			}
			...
			super.state(context, initialsLikeName, "employeeCode", "acme.constraints.ValidAgent.message");
		}
